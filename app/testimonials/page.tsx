...
export const metadata: Metadata = {
  title: 'Testimonials | Sterling Events Catering',
  description: 'Read what our clients say about their Sterling Events Catering experience.',
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-primary-200 max-w-3xl mx-auto">
              Hear from our satisfied clients about their Sterling Events experience.
            </p>
          </div>
        </div>
      </section>
