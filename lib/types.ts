...
export interface DrupalMenuPackage {
  id: string
  title: string
  path?: string
...
export interface MenuPackagesData {
  nodeMenuPackages: {
    nodes: DrupalMenuPackage[]
  }
}

export interface DrupalEventType {
  id: string
  title: string
  path?: string
  body?: { processed: string; summary?: string }
